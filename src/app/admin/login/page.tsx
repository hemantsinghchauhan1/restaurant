    ...
    <main className="min-h-screen bg-slate-950 flex items-center justify-center p-4 text-slate-100">
      ...
      >
        <div className="text-center space-y-1">
          <div className="w-12 h-12 bg-blue-500/10 border border-blue-500/30 text-blue-400 rounded-2xl flex items-center justify-center mx-auto mb-1">
            <ShieldCheck className="w-7 h-7" />
          </div>
          <h1 className="text-xl font-black text-slate-50">Admin Control Center</h1>
          <p className="text-xs text-slate-400">Sign in with Clerk for full platform management</p>
        </div>
          ...
          <SignIn
            ...
            appearance={{
              elements: {
                ...
                formButtonPrimary: 'bg-blue-600 hover:bg-blue-500 text-white font-black',
