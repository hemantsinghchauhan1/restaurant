  ...
  return (
    <main className="min-h-screen bg-slate-950 flex items-center justify-center p-4 text-slate-100">
      ...
      >
        ...
        <div className="p-3.5 bg-blue-500/10 border border-blue-500/30 rounded-2xl flex items-center justify-between gap-2">
          <div className="text-xs">
            <span className="font-bold text-blue-400 block">👑 Super Admin Demo Account:</span>
            <span className="text-[11px] text-slate-300 font-mono">admin@restaurant.com / admin123</span>
          </div>
          <button
            type="button"
            onClick={handleFillAdmin}
            className="px-3.5 py-1.5 bg-blue-600 hover:bg-blue-500 text-white text-xs font-black rounded-xl shrink-0 transition-all shadow-md flex items-center gap-1"
          >
