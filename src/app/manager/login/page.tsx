    ...
    <main className="min-h-screen bg-slate-950 flex items-center justify-center p-4 text-slate-100">
      ...
      >
        <div className="text-center space-y-1">
          ...
          <h1 className="text-xl font-black text-slate-50">Manager Portal</h1>
          <p className="text-xs text-slate-400">Sign in with Clerk for order fulfillment & cash counter</p>
        </div>
